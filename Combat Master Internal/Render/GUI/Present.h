...
namespace GUI
{
    ...
    HRESULT __stdcall hkPresent(IDXGISwapChain* pSwapChain, UINT SyncInterval, UINT Flags)
    {
        ...
        if (Menu::bWatermark) {
            char buffer[42];
            snprintf(buffer, sizeof(buffer), "ICB-CM v.1.0 - Made By ntjq");
        ...
        if (Menu::bIsOpen)
        {
            ...
            ImGui::Begin("ICB-CM v.1.0", nullptr, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoCollapse);
            ...
            if (Menu::currentPage == 0) {
                ...
                if (ImGui::Button("Aimbot", tabSize))
                    Menu::currentPage = 0;
            ...
            else if (Menu::currentPage == 2)
            {
                ...
                ImGui::BeginChild("Misc", ImVec2(0, 140), true);
                ImGui::PushStyleColor(ImGuiCol_Text, ImVec4(0.0f, 0.8f, 0.8f, 1.0f));
                ImGui::Text("Misc");
                ImGui::PopStyleColor();
                ImGui::Separator();
                ...
                // Movement & Misc Section (MOVED HERE)
            ...
            else if (Menu::currentPage == 3)
            {
                ...
                ImGui::TextWrapped("Thank you for using ICB CM\n\ncredit:");
                ImGui::BulletText("ntjq");
                ImGui::BulletText("Russi");
                ImGui::PopStyleColor();
